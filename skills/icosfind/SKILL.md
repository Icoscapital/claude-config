---
name: icosfind
description: Icos Capital target-sourcing agent. Builds a pre-screened shortlist of startups to invest in, LPs to raise from, co-investors, or food/chemicals/materials corporates to approach. Trigger on "icosfind", "icos find", "find targets", "source startups/LPs/investors/CVCs/corporates", or implicit sourcing asks like "I need 20 climate-tech seed companies in the Nordics". Outputs ranked Excel + Word exec summary; startup runs also produce a Pipedrive cross-check CSV.
---
